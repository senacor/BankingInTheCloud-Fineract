...
mkdir -p fineract-project
cd fineract-project

#####################################################################################
# setup the complete project sructure by creating a folder structure and cloning the
# project repositories into it.
githubAccount=mifosio
