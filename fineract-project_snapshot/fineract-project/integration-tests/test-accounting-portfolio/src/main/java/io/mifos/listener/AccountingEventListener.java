...
public class AccountingEventListener {
  ...
  @Autowired
  public AccountingEventListener(final EventRecorder eventRecorder) {
  ...
  public void onCreateLedger(@Header(TenantHeaderFilter.TENANT_HEADER) final String tenant,
